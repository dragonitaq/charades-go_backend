...
const convertCSVTo1DArray = async (filePath, encoder) => {
  let newArray;
  try {
    let textFile = await readFile(`${__dirname}/${filePath}`, encoder);
...
convertCSVTo1DArray('../data/enteronly - crlf.txt', 'utf-8');

export default convertCSVTo1DArray;
